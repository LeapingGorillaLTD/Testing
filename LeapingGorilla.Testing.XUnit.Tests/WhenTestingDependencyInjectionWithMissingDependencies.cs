...
{
	public class WhenTestingDependencyInjectionWithMissingDependencies : WhenTestingTheBehaviourOf
	{
		...
		{
			Assert.IsType<NoMatchingConstructorFoundException>(_setupException);
		}
	}
}
